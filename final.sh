...
docker exec proms-1 sh -c "/root/proms/prometheus --config.file=/root/proms/prometheus.yml" &&\
docker exec proms-1 sh -c "/root/alerts/alertmanager --config.file=/root/alerts/alertmanager.yml"